...
/**
 *   @file      register.php
 *   @brief     display the register form
...
<html lang="fr">
<head>
    <title>WebelWeiss - s'inscrire</title>
    <meta charset="UTF-8">
...
<div class="limiter">
    <div class="container-login100" style="background-image: url('assets/img/LoginBackground.gif');">
        ...
        <form class="login100-form" method="post" action="index.php?action=login" id="LoginForm">
            ...
            <div class="wrap-input100 m-b-10">
                <input class="input100" type="password" name="confirmPassword" placeholder="confirmer le mot de passe" required>
                <span class="focus-input100"></span>
                <span class="symbol-input100">
							<i class="fa fa-lock"></i>
						</span>
